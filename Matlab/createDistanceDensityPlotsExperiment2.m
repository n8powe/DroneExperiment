function createDistanceDensityPlotsExperiment2()
...
%                     avgDistancesP = [avgDistancesP, mean(distances)];
    ...
    if plotAverageDensity
        ...
        hold off;
        title('Gaze Distance Density - Dense Trees','fontsize',fontSize)
        xlabel('Distance (m)','fontsize',fontSize)
        ylabel('P','fontsize',fontSize)
        %ylim([-0.005, 0.05])
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
