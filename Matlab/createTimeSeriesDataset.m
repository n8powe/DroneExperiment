function createTimeSeriesDataset()
    subjectDataSets = {'P_210930142529_100', 'P_211013154622_50', 'P_210928152127_40',  'P_220207122313_Nate', 'P_210929172928_200_300','P_211015152112_10'};
    ...
    for sb = subjectDataSets
        ...
        for cnd = conditions
            ...
            for b=1:length({positionFolderInfo(:).name})
                ...
                if dfLogical == 0
                    currentDF = runAnalyses(sb{1}, cnd{1}, block, posData, hoopPositionData, hoopData, true);
                    dfLogical=1;
                else
                    DF = runAnalyses(sb{1}, cnd{1}, block, posData, hoopPositionData, hoopData, true);
    ...
    writetable(currentDF, 'timeSeriesHoopSegmentAngles_allSubjects_grad.txt');
